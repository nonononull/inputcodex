...
- 当前共有 42 个 feature，其中 10 个为 `exception-pending`。
...
- 当前五域共保存 `42` 份行为合同，并为 `11` 个需要结构数据的 feature 保存 `11` 个 fixture manifest；其余场景以合同中的 `fixture_policy: none` 说明无需 fixture。
