...
$sideEffectAdmissionStringsValid =
    ...
    $sideEffectAdmissionDecisionId -ceq 'gate5-side-effect-admission-matrix-v1' -and
    $sideEffectAdmissionOwnerDecisionRef -is [string] -and
    $sideEffectAdmissionOwnerDecisionRef -ceq 'https://github.com/nonononull/inputcodex/issues/140#issuecomment-5168939607' -and
    $sideEffectAdmissionTrackingIssueRef -is [string] -and
    $sideEffectAdmissionTrackingIssueRef -ceq 'https://github.com/nonononull/inputcodex/issues/145' -and
    ...
    $sideEffectAdmissionBaselineCommit -ceq '42c73f401e7a758cdc5eca374613625dad46340b' -and
...
if (-not $sideEffectAdmissionValid) {
    Add-Violation 'SIDE_EFFECT_ADMISSION_MATRIX' '副作用准入矩阵策略必须锁定 #145、单治理批次、83 个 source、零产品交付与 implementation_authorized=false'
}
