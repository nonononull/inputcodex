...
$sideEffectAdmissionStringsValid =
    ...
    $sideEffectAdmissionDecisionId -ceq 'gate5-strict-json-object-recovery-v1/batch-2' -and
    $sideEffectAdmissionOwnerDecisionRef -is [string] -and
    $sideEffectAdmissionOwnerDecisionRef -ceq 'https://github.com/nonononull/inputcodex/issues/140#issuecomment-5180271732' -and
    $sideEffectAdmissionTrackingIssueRef -is [string] -and
    $sideEffectAdmissionTrackingIssueRef -ceq 'https://github.com/nonononull/inputcodex/issues/153' -and
    ...
    $sideEffectAdmissionBaselineCommit -ceq 'f3e7d6f873f59399e71b602e1a9fbdee71760d64' -and
