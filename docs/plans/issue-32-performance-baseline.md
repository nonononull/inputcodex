...
## Task 5A：Windows Evidence 换行根因修复与重测

- [x] 最终 Head `e679eee64442f0ae4db97b4e9cdbfab6780ea1de` 的 Run `30170128309` 复现 Windows 两份结果原始哈希失配；macOS Evidence 成功，同 Head 主 CI Run `30170128326` 七 Job 全绿。
